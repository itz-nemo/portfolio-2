...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "fa6510a6-9f2d-4b80-abd9-3ef6864a3721");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      I'd love to hear from you! If you want to connect or have any questions, comments, or feedback, please use the form below.</motion.p>
